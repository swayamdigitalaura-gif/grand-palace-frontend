  ...
  "indian-restaurant-near-martin-place": {
    ...
    sections: [
      ...
      },
      {
        heading: "Conclusion",
        body: [
          "If you're based around Martin Place and want more than another desk lunch or food-court run, The Grand Palace is close enough to reach comfortably within a lunch break and worth the short walk for dinner after work. Between the sit-down dining room, private spaces for client meetings, and catering options for larger office groups, it covers most of what a Martin Place team actually needs from a nearby restaurant.",
        ],
      },
    ],
    faq: [
  ...
  "indian-restaurant-near-town-hall-station": {
    ...
    sections: [
      ...
      },
      {
        heading: "Conclusion",
        body: [
          "From Town Hall, reaching The Grand Palace is a quick one-stop train ride or a straightforward 15-minute walk up George Street — a small detour for a genuine sit-down Indian dining experience rather than another quick-service option near the station. For a proper lunch or dinner, or a group booking that needs more than a food-court table, it's worth the trip up the strip.",
        ],
      },
    ],
    faq: [
