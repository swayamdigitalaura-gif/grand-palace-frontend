...
export type GuideSection = { heading: string; body: string[]; bullets?: string[]; image?: string; imageAlt?: string; bannerIcon?: string; blockType?: GuideBlockType; items?: string[] };
